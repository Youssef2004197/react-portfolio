    ...
    >
      ...
      <div className="flex justify-center">
        ...
        <div className="card rounded-xl2 p-5 w-full max-w-[320px]">
          ...
          {/* Project Info */}
          <h3 className="text-xl mb-2">Birthday</h3>

          <p className="text-sm text-ink-muted mb-4">
            An interactive birthday surprise website built with React,
            Tailwind CSS, HTML, CSS, and JavaScript, featuring animations,
            interactive cards, music, and a personalized birthday experience.
          </p>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* GitHub Button */}
              <a
                href="https://github.com/Youssef2004197/Birthday.git"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Birthday GitHub Repository"
                className="flex-shrink-0 inline-flex items-center justify-center w-11 h-11 rounded-full bg-white text-black hover:bg-transparent hover:text-white transition-all"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              {/* Live Website Button */}
              <a
                href="https://birthday-black-seven-92.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Birthday Live Website"
                className="flex-shrink-0 inline-flex items-center justify-center w-11 h-11 rounded-full bg-white text-black hover:bg-transparent hover:text-white transition-all"
              >
                <svg
                  viewBox="0 0 24 24"
